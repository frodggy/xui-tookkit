...
var xui = (__webpack_require__(/*! ../lib/index */ "../lib/index.js")["default"]);
  ...
  _App = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            count = xui.addState(1);
            console.log(count.value);
            count.update(count.value + 1);
            console.log(count.value);
            return _context.abrupt("return", xui.nsx("\n        <div>\n            <h1>count: ".concat(count.value, "</h1>\n            <p>This is a simple example of a template literal</p>\n        </div>\n   ")));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            _context.t2 = document.getElementById('app');

            _context.t0.render.call(_context.t0, _context.t1, _context.t2);
